...
namespace SigrunsWings
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            EnableMod = Config.Bind(new ConfigDefinition("SigrunsWings", "EnableMod"), true, new ConfigDescription("Enables the mod. If false, the mod will not work then next time you load the game."));
            EnableDebugging = Config.Bind(new ConfigDefinition("SigrunsWings", "EnableDebugging"), true, new ConfigDescription("Enables the debugging"));


            // DevMode = Config.Bind(new ConfigDefinition("SigrunsWings", "DevMode"), false, new ConfigDescription("Enables all of the things for testing."));
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Lets Sigrun Fly!",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/SigrunsWings",
                _contentFolder: "SigrunsWings"
            );
